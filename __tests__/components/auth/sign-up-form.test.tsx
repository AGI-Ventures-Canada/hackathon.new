...
describe("SignUpForm", () => {
  ...
  describe("OAuth", () => {
    it("carries the judging invitation through Google signup without organization onboarding", async () => {
      const destination = "/judge-invite/token?accept=true"
      render(<SignUpForm redirectUrl={destination} initialEmail="judge@example.com" />)
      fireEvent.click(screen.getByText("Google"))
      await waitFor(() => expect(signUpAuthenticateWithRedirect).toHaveBeenCalledWith({
