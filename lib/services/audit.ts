...
export type AuditAction =
  ...
  | "credential.deleted"
  | "hackathon.created"
  | "hackathon.test_event_created"
  | "hackathon.test_event_converted"
  | "hackathon.updated"
  ...
  | "room_judge.added"
  | "room_judge.removed"
  | "hackathon.auto_assign_by_room.updated"
  | "hackathon.auto_assign_by_room.synced"
  | "team.created"
  ...
  | "team.mode_updated"
  | "team.updated"
  | "team_invitation.replaced"
  | "participant.team_changed"
  ...
  | "organizer_task.created"
  | "organizer_task.updated"
  | "organizer_task.deleted"
  | "schedule_item.created"
  | "schedule_item.updated"
  | "schedule_item.deleted"
  | "presenter_view.created"
  | "presenter_view.updated"
  | "presenter_view.deleted"
