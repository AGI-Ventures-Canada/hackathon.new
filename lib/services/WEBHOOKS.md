...
When a trigger has an idempotency key, Oatmeal checks for a successful delivery
...
- A receiver can accept the POST before Oatmeal fails to record the success. A
