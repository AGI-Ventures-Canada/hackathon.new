-- Update organizer poll RPC to include judging round counts so the
-- "activate your first round" action item can refresh live from the poll
-- without a page reload.
--
-- Adds three counts grouped by judging_rounds.status:
--   - planned_round_count:  status = 'planned'
--   - active_round_count:   status = 'active'
--   - complete_round_count: status IN ('complete', 'advanced')
