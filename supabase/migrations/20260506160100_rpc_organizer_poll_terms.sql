-- Extend organizer poll RPC to include terms_content so the
-- "add terms and conditions" action item auto-completes after the
-- organizer saves their terms (without requiring a full page reload).
