-- Update organizer poll RPC for multi-challenge support:
-- - Drop the old challenge_title field (column is gone).
-- - Add challenge_count so callers can check "has at least one challenge" without
